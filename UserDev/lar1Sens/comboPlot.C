...

{
  ...
  plotUtils.add_plot_label((char*)"#nu mode, CC Events", 0.93, 0.69, 0.025, 1, 62,32);
  plotUtils.add_plot_label((char*)"Reconstructed Energy", 0.93, 0.66, 0.025, 1, 62,32);
  ...
  plotUtils.add_plot_label((char*)"90\% Confidence Limits", 0.93, 0.57, 0.025, 1, 62,32);
  ...
  files.push_back("files/nue_appearance_ecalo2_covMat_ND_100mT600_onaxisnu_flatStats_shapeOnly_chi2.root");
  files.push_back("files/nue_appearance_ecalo2_covMat_ND_150mT600_onaxisnu_flatStats_shapeOnly_chi2.root");
  files.push_back("files/nue_appearance_ecalo2_covMat_ND_200mT600_onaxisnu_flatStats_shapeOnly_chi2.root");
  ...
  names90.push_back("ND @ 100m, T600 @ 600m, off axis");
  names90.push_back("ND @ 150m, T600 @ 600m, off axis");
  names90.push_back("ND @ 200m, T600 @ 600m, off axis");
  ...
  names5s.push_back("5#sigma limit, ND @ 100m, T600 @ 600m, on axis");
  names5s.push_back("5#sigma limit, ND @ 150m, T600 @ 600m, on axis");
  names5s.push_back("5#sigma limit, ND @ 200m, T600 @ 600m, on axis");
  names5s.push_back("5#sigma limit, ND @ 100m, T600 @ 600m, off axis");
  names5s.push_back("5#sigma limit, ND @ 150m, T600 @ 600m, off axis");
  names5s.push_back("5#sigma limit, ND @ 200m, T600 @ 600m, off axis");
  ...
  TLegend * graphLeg = new TLegend(.54,.75,.93,.85);
  ...
  for (auto j = index.begin(); j != index.end(); j++){
    ...
    sens90 -> Draw("l same");
    graphLeg->AddEntry(sens90,names90[i].c_str(),"l");
