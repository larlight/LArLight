...
def make_plots():
    ...
    tels=TChain("scanner/shower_tree","")
    tels.AddFile("out_electrons.root")
    mctels=TChain("scanner/mctruth_tree","")
    mctels.AddFile("out_electrons.root")
    tels.AddFriend(mctels)
