#ifndef CFALGOVOLUMEOVERLAP_CXX
#define CFALGOVOLUMEOVERLAP_CXX
...
namespace cmtool {
  ...
  //-------------------------------------------------------
  CFAlgoVolumeOverlap::CFAlgoVolumeOverlap() : CFloatAlgoBase()
  //-------------------------------------------------------
  {
  ...
  //-----------------------------
  void CFAlgoVolumeOverlap::Reset()
  //-----------------------------
  {
  }
  ...
  //------------------------------
  void CFAlgoVolumeOverlap::Report()
  //------------------------------
  {
