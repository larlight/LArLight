...
/** \addtogroup CMTool
    ...
    @{*/
#ifndef CPALGOIGNORETRACKS_HH
#define CPALGOIGNORETRACKS_HH
  ...
  */
  ...
  public:
    ...
    */
    ...
    bool IsTrack(const ::cluster::ClusterParamsAlgNew &cluster);
    ...
    void SetMinMHitWires(UInt_t BOKE) { _min_multihit_wires = BOKE; }
