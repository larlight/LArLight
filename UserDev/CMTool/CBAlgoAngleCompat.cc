#ifndef CBALGOANGLECOMPAT_CXX
#define CBALGOANGLECOMPAT_CXX

#include "CBAlgoAngleCompat.hh"
...
namespace cmtool {
  ...
  bool CBAlgoAngleCompat::Bool(const ::cluster::ClusterParamsAlgNew &cluster1,
