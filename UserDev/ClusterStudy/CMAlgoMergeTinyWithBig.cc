#ifndef CMALGOMERGETINYWITHBIG_CXX
#define CMALGOMERGETINYWITHBIG_CXX
...
namespace cluster {
  ...
  //-------------------------------------------------------
  CMAlgoMergeTinyWithBig::CMAlgoMergeTinyWithBig() : CBoolAlgoBase()
  //-------------------------------------------------------
  {
    SetMinHitsBig(50);
    SetMaxHitsBig(99999);
  ...
  //-----------------------------
  void CMAlgoMergeTinyWithBig::Reset()
  //-----------------------------
  {
  ...
  //----------------------------------------------------------------
  bool CMAlgoMergeTinyWithBig::Bool(const ClusterParamsAlgNew &cluster1,
  ...
  //------------------------------
  void CMAlgoMergeTinyWithBig::Report()
  //------------------------------
  {
