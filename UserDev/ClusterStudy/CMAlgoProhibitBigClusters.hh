/**
 * \file CMAlgoProhibitBigClusters.hh
 *
 * \ingroup ClusterStudy
 * 
 * \brief Class def header for a class CMAlgoProhibitBigClusters
 *
...
/** \addtogroup ClusterStudy
    ...
    @{*/
#ifndef CMALGOPROHIBITBIGCLUSTERS_HH
#define CMALGOPROHIBITBIGCLUSTERS_HH
...
namespace cluster {
  ...
  */
  class CMAlgoProhibitBigClusters : public CBoolAlgoBase {
    
  public:
    
    /// Default constructor
    CMAlgoProhibitBigClusters();
    
    /// Default destructor
    virtual ~CMAlgoProhibitBigClusters(){};
