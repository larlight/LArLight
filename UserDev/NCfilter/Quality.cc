...
//-----------------------------------------------------------------------------------------------------------------------
  ...
  std::vector<std::pair<double,double>> Quality::ProtoVertexCW( const std::vector<std::pair<std::vector<unsigned int>,std::vector<unsigned int>>> Regions, const larlight::event_hit* hits ) {
...
//-----------------------------------------------------------------------------------------------------------------------
/*
  std::vector<bool> Quality::PlaneCheck(std::vector<std::pair<std::vector<unsigned int>,std::vector<unsigned int>>> Regions, std::vector<std::vector<larlight::hit>> hits  ) {
