...
//--------------------------------------------------------------------------------------------------------------------------------------
  std::vector<std::pair<double,double>> DivReg::FlipLineC(const std::vector<larlight::cluster>& clusters, const std::vector<larlight::hit>& hits) const
  {
// first 
...
//--------------------------------------------------------------------------------------------------------------------------------------
  std::vector<std::pair<double,double>> DivReg::RotateLineC(const std::vector<larlight::cluster>& clusters, const std::vector<larlight::hit>& hits) const
  {
