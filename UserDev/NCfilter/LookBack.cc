...
namespace cluster {
  ...
  std::pair<double,double> LookBack::CWAngle(std::vector<unsigned int> hitindex, std::vector<larlight::hit> hitsvect){
  ...
  std::pair<std::vector<unsigned int>,std::vector<unsigned int>> LookBack::ClusterRefine(std::pair<std::vector<unsigned int>,std::vector<unsigned int>> hitpair, std::vector<larlight::hit> hitsvect){
...
/*
//-----------------------------------------------------------------------------------------------------------------------
  std::vector<bool> PlaneCheckMatch::PlaneCheck(const std::vector<std::pair<std::vector<unsigned int>,std::vector<unsigned int>>> Regions, const larlight::event_hit* hits  ) {
