...
FluxRW::FluxRW()
{
  ...
  string mbhistfile="FluxRW/hist/april07_baseline_rgen610.6_flux.root";
  ...
  string nu[4]={"nue","nuebar","numu","numubar"};

  for (Int_t intype=1;intype<=4;intype++) {
	std::string gshistfile(Form("FluxRW/hist/%s_rawntp.root",nu[intype-1].c_str()));
