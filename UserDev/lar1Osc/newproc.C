
{
  ...
  // ntuple_100m_nu.Loop("nue",0,0,-1,false);
  // ntuple_100m_nu.Loop("numu",0,0,-1,false);
  ...
  // ntuple_470m_nu.Loop("nue",1,4,-1,false);
  // ntuple_470m_nu.Loop("numu",1,4,-1,false);
  ...
  // ntuple_600m_onaxis_nu.Loop("nue",2,5,-1,false);
  // ntuple_600m_onaxis_nu.Loop("numu",2,5,-1,false);
