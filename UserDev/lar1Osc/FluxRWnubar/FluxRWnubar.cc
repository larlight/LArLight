...
using namespace std;
	...
	FluxRWnubar::FluxRWnubar()
	{
	  ...
	  std::string mbhistfile="FluxRWnubar/hist/december2007_horn-174ka_rgen610.6_flux.root";
	  ...
	  for (Int_t intype=1;intype<=4;intype++) {
		std::string gshistfile(Form("FluxRWnubar/hist/%s_nubarntp.root",nu[intype-1].c_str()));
