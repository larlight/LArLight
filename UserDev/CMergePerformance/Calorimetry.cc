...
namespace larlight {
  ...
  bool Calorimetry::analyze(storage_manager* storage) {
  ...
  //-------------------------------
  void Calorimetry::PrepareHistos(){
  ...
  //--------------------------------------------------
  void Calorimetry::GetHits(cluster* clus, event_hit* ev_hits,
  ...
  //--------------------------------------------------
  float Calorimetry::GetEnergy( std::vector<larutil::PxHit> clusHits ){
  ...
  //--------------------------------------------------
  void Calorimetry::GetParams( std::vector<larutil::PxHit> clusHits ){
  ...
  //--------------------------------------------------
  float Calorimetry::dEdxBox( float dQdx ){
  ...
  //--------------------------------------------------
  float Calorimetry::dQdEBirks( float dQdx ){
  ...
  float Calorimetry::Pi0Mass( float angle1, float Q1, float angle2, float Q2){
  ...
  void  Calorimetry::dEdx( std::vector<float> & dEdx_vec,
  ...
  //Take a cluster, its hits and make a vector of dEdx
  //for the hits in that cluster up to some distance
  void  Calorimetry::dEdx( cluster* clus, event_hit* ev_hits,
			   larlight::DATA::DATA_TYPE hit_type,
  ...
  //------------------------------------------------------------------------
  void Calorimetry::FillClusterParamsVector(event_cluster* ev_cluster,
						  event_hit* ev_hits){
  ...
  //--------------------------------------------------------------
  std::vector< std::vector<int> > Calorimetry::FindBestClusters(event_mcshower* ev_mcshower,
