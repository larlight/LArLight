...
namespace larlight {
  ...
  class event_opflash : public std::vector<larlight::opflash>,
			public event_base {
    
  public:

    /// Default ctor
    event_opflash() : event_base(DATA::OpFlash) {clear_data();}

    /// Default copy constructor
    event_opflash(const event_opflash& original) : std::vector<larlight::opflash>(original),
						   event_base(original)
    {}
