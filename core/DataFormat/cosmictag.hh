...
namespace larlight {
  ...
  class event_cosmictag : public std::vector<larlight::cosmictag>,
			  public event_base {
    
  public:
    /// Default constructor
    event_cosmictag() : event_base(DATA::CosmicTag) { clear_data();}
    
    /// Default copy constructor
    event_cosmictag(const event_cosmictag& original) : std::vector<larlight::cosmictag>(original),
						       event_base(original)
    {}
