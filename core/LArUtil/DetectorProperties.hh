...
/** \addtogroup LArUtil
    ...
    @{*/
#ifndef DETECTORPROPERTIES_HH
#define DETECTORPROPERTIES_HH
...
namespace larutil {
  ...
  */
  ...
  public:
    ...
    // Following functions are intentionally commented out by Kazu for LArLight
